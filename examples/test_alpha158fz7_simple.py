#!/usr/bin/env python3
"""
简化的 Alpha158FZ7 测试脚本 - 只测试特征配置，避免多进程问题
"""
...
print("=== 测试 Alpha158FZ7 特征配置 ===")

# 测试配置 - 使用修复后的 Alpha158DL
conf = {
    "kbar": {},
...
try:
    ...
    # 显示对应的表达式
    print(f"\nFactorZoo 因子对应的表达式:")
    fz_keywords = ['Max($high', 'Mad($high', 'UpStd', 'Kurt', 'Corr', 'Max($close', 'Min($close']

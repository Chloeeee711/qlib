...
# ====== 天勤数据目录 - 历史数据路径（用于训练） ======
KQ_DATA_DIR = Path(r"C:\Users\ASUS\qlib_data_ipynb")  # 历史数据根目录
RAW_DIR = Path(r"C:\Users\ASUS\kq_raw_data_ipynb")  # 历史原始数据
...
FEATURES_DIR = Path(r"C:\Users\ASUS\qlib_data_ipynb\features")  # 使用历史数据路径
